...
<div class="sidebar ">
  ...
  <button class="dropdown-btn active" style="height:50px;background-color: #04AA6D;color:white;">Fee Details
    <i class="fa fa-caret-down"></i>
  </button>
  <div class="dropdown-container">
    <a href="tuition_fee.php">Tuition Fee</a>
    <a href="exam_fee.php">Exam Fee</a>
    <a href="transportation.php"  class="active">Transportation Fee</a>
  </div>
